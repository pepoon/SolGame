...
namespace DOTSNET
{
    ...
    [DisableAutoCreation]
    public class DistanceInterestManagementSystem : InterestManagementSystem
    {
        // visibility radius
        ...
        void RebuildObservers()
        {
            ...
            NativeMultiHashMap<int, Entity> serverOwnedPerConnection = server.ownedPerConnection;
                              ...
                              in NetworkIdentity identity) =>
            {
                ...
                for (int i = 0; i < observers.Length; ++i)
                {
                    ...
                    if (!rebuild.Contains(connectionId))
                    {
                        ...
                        UnspawnMessage message = new UnspawnMessage(identity.netId);
                              ...
                              in NetworkComponentsSerialization serialization) =>
            {
                ...
                for (int i = 0; i < rebuild.Length; ++i)
                {
                    ...
                    if (!observers.Contains(connectionId))
                    {
                        ...
                        bool owned = identity.connectionId == connectionId;
        ...
        public override void OnRebuildAll()
        {

...
namespace DOTSNET
{
    ...
    {
        // implicit conversions to reduce typing
        public static implicit operator int(RebuildNetworkObserver e) => e.connectionId;
        public static implicit operator RebuildNetworkObserver(int e) => new RebuildNetworkObserver{connectionId = e};

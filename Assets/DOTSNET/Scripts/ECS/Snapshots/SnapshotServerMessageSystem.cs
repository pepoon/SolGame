...
namespace DOTSNET
{
    ...
    public class SnapshotServerMessageSystem : NetworkServerMessageSystem<SnapshotMessage>
    {
        // dependencies
        ...
        NativeHashMap<ulong, SnapshotMessageAndConnectionId> messages;
        ...
        protected override void OnCreate()
        {
            ...
            messages = new NativeHashMap<ulong, SnapshotMessageAndConnectionId>(1000, Allocator.Persistent);
        }
        ...
        protected override void OnUpdate()
        {
            ...
            NativeHashMap<ulong, Entity> _spawned = server.spawned;
            Job.WithCode(() => {

        ...
        public override void Connect(string hostname)
        {
            ...
            client = NonAlloc
                ? new KcpClientNonAlloc(
                    () => OnConnected.Invoke(),
                    (message) => OnData.Invoke(ArraySegmentToNativeSlice(message, receiveConversionBuffer)),
            ...
            client.Connect(hostname, Port, NoDelay, Interval, FastResend, CongestionWindow, SendWindowSize, ReceiveWindowSize, Timeout);
        }

...
namespace DOTSNET
{
    public static class Extensions
    {
        ...
        public static ulong GetStableHashCode(this ComponentType type)
        {
            ...
            return TypeManager.GetTypeInfo(type.TypeIndex).StableTypeHash;
        }
            ...
            where TValue : struct
        {
            ...
            NativeMultiHashMapIterator<TKey>? iterator = default;
        ...
        public static void CopyTo<TKey, TValue>(this NativeHashMap<TKey, TValue> map, NativeHashMap<TKey, TValue> destination)
            where TKey : struct, IEquatable<TKey>
            where TValue : struct
        {
            destination.Clear();
